...
main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("vehicle-visualizer", "Activate the web-based vehicle visualizer for the simulator", vehicle_vis);
  ...
  ***/
  ...
  /* Create and setup the web-based vehicle visualizer of the simulator */
